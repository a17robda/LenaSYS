...
<head>
	...
	<title>Result Editor On Johans Repohoho</title>
    ...
    <div id="ladexportContainer" style="display:flex;">
      ...
      <div style="display:flex;flex-direction:column;justify-content:space-between;margin:5px;">
        ...
        <select id="ladgradescale">
          <option value="U-G-VG" selected>U-G-VGGG</option>
          <option value="U-G">U-GGG</option>
      ...
      <button onclick="ladexport();">LadExport</button>
		...
		<div id='searchBar' style='test-align:right;margin-bottom:5px;'>
			<input id='searchinput' type='text' name='search' placeholder='Search..HEEEJ' onkeyup='searchterm=document.getElementById("searchinput").value;searchKeyUp(event);myTable.reRender();'/>
