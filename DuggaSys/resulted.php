  ...
  <!-- content START -->
	<div id="content">
		<div class="titles" style="justify-content:center;">
			<h1>Result</h1>
			<h1 style="font-size: 45px">HELLOOOOOOOOOOOOOOOOO</h1>
    </div>
    <div id="ladexportContainer" style="display:flex;">
      ...
      <button onclick="ladexport();">LadExport</button>
		...
		<div id='searchBar' style='test-align:right;margin-bottom:5px;'>
			<input id='searchinput' type='text' name='search' placeholder='Hej hej heje hej ' onkeyup='searchterm=document.getElementById("searchinput").value;searchKeyUp(event);myTable.reRender();'/>
