  ...
  if (querystring['coursevers'] != "null") {
    ...
    if (data['entries'].length > 0) {
      ...
      for (i = 0; i < data['entries'].length; i++) {
        ...
        // kind 0 == Header || 1 == Section || 2 == Code  ||ï¿½3 == Test (Dugga)|| 4 == Momentï¿½|| 5 == Link || 6 Group-Moment
        ...
        // kind 0 == Header || 1 == Section || 2 == Code  ||ï¿½3 == Test (Dugga)|| 4 == Momentï¿½|| 5 == Link || 6 == Group || 7 == Comment
        ...
        if (itemKind == 0) {
          ...
          str += "<div class='nowrap" + hideState + "' style='margin-left:8px;display:flex;align-items:center;' title='" + item['entryname'] + "'>";
          // HÄR KAN JAG LÄGGA TILL SÅ DATUMEN SYNS
