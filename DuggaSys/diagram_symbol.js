...
function Symbol(kind) {
    ...
    this.draw = function () {
        ...
        ctx.properties['font'] = "bold " + parseInt(this.properties['textSize']) + "px " + this.properties['font'];
    ...
    this.drawUML = function(x1, y1, x2, y2)
    {
        ...
        ctx.properties['font'] = "bold " + parseInt(this.properties['textSize']) + "px Arial";
        ...
        ctx.properties['font'] = parseInt(this.properties['textSize']) + "px Arial";
    ...
    this.drawEntity = function(x1, y1, x2, y2){
        ...
        ctx.properties['font'] = parseInt(this.properties['textSize']) + "px " + this.properties['font'];
    }
